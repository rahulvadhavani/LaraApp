                        ...
                        <div class="row">
                            <div class="col-xs-12 mt-3 col-sm-12 col-md-6">
                                <div class="form-group">
                                    <strong>Title:</strong>
                                    <input required value="{{old('title',$post->title)}}" type="text" name="title" class="form-control" placeholder="Enter Title">
                                </div>
                                @error('title')
                            ...
                            <div class="col-xs-12 mt-3 col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="description" class="form-control" id="description" rows="3">{{old('description',$post->description)}}</textarea> <label for="description">Description</label>
                                </div>
                                @error('description')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            ...
                            <div class="mt-3 row">
                                ...
                                <div class="col-xs-12  col-sm-12 col-md-6 d-done" id="image_preview_div">
                                    <img src="{{$post->image}}" alt="" id="image_preview" width="70px">
                                </div>
                                @error('image')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
